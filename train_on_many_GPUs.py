...
def fetch_fineweb_data(max_chars: int = 2**22):
    ...
    # TODO find a way to read data that's not limited by CPU RAM (oftentimes collective GPUs have more)
...
def train_simple_encoding(sample_size: int, vocab_size: int, k: int = 256):
    ...
    enc = SimpleBytePairEncoding.train(data, vocab_size=vocab_size, pat_str=gpt4_pattern, k=k)
